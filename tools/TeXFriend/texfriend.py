...
menu_file.add_command(label=LANG["Open"], command=do_nothing)
menu_file.add_command(label=LANG["Save"], command=do_nothing)
menu_file.add_command(label=LANG["New"], command=do_nothing)
...
menu_setting.add_cascade(label=LANG["Language"], menu=menu_setting_lang, underline=False)
